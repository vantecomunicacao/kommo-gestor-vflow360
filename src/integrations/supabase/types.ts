  ...
  kommo: {
    Tables: {
      ...
      dashboard_cache: {
        ...
        Relationships: [
          {
            foreignKeyName: "dashboard_cache_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      check_stale_syncs: { Args: never; Returns: undefined }
      cleanup_dashboard_cache: { Args: never; Returns: undefined }
      create_workspace: { Args: { _name: string }; Returns: string }
      delete_ai_provider_config: {
        Args: { p_user_id: string; p_workspace_id: string }
        Returns: undefined
      }
      error_webhook_url: { Args: never; Returns: string }
